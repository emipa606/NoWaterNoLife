...
namespace MizuMod
{
    public class ThinkNode_ConditionalStockWaterForPrisoner : ThinkNode_Conditional
    {
        protected override bool Satisfied(Pawn pawn)
        {
            ...
            // 部屋にいる人数を取得
            var prisonerNum = myRoom.Owners.Count();
            ...
            foreach (var t in pawn.Map.listerThings.AllThings)
            {
                ...
                if (comp == null || comp.SourceType != CompProperties_WaterSource.SourceType.Item || comp.WaterAmount < Need_Water.MinWaterAmountPerOneDrink)
                {
                    continue;
                }
